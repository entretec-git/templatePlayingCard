...
{
    NSDictionary *colorMappings = @{ @"Red" : [UIColor redColor],@"Black" : [UIColor blackColor],@"Blue" : [UIColor blueColor] };
...
- (UIColor *)shadeColor
{
    ...
    NSDictionary *shadedColorMappings = @{ @"Red"   : [UIColor colorWithRed:1.0 green:0.0 blue:0.0 alpha:0.3],
                                           @"Black" : [UIColor colorWithRed:1.0 green:1.0 blue:1.0 alpha:0.3],
